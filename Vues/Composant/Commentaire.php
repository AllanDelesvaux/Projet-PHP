	...
	<div class="bg-black text-white py-20">
		<div class="container mx-auto flex flex-col md:flex-row my-6 md:my-24">
			<div class="flex flex-col w-full lg:w-1/3 p-8">
				<p class="ml-6 text-yellow-300 text-lg uppercase tracking-loose">Appréciation</p>
				<p class="text-3xl md:text-5xl my-4 leading-relaxed md:leading-snug">Donnez votre avis sur la recette!</p>
				<p class="text-sm md:text-base leading-snug text-gray-50 text-opacity-100">
					N'hésitez pas à nous partagez vos conseils, et retours sur cette recette ;)
				</p>
			</div>
