<section class="bg-white dark:bg-zinc-800">
    <div class="container px-6 py-10 mx-auto">
        <div class="grid grid-cols-1 gap-8 md:grid-cols-2 xl:grid-cols-3">
            <div>
                <img class="object-cover object-center w-full h-64 rounded-lg lg:h-80" src="https://place-hold.it/500x300/667" alt="">
            ...
            <div>
                <img class="object-cover object-center w-full h-64 rounded-lg lg:h-80" src="https://place-hold.it/500x300/667" alt="place_holder">
