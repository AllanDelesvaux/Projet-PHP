...
<figure class="flex flex-col justify-start items-center p-8 text-center bg-gray-50 md:p-12 dark:bg-gray-800 md:ml-6 dark:border-gray-700">
    ...
    <?php Vue::montrer("Composant/zoneDeRecherche") ?>
        <button type="submit" class="group relative flex justify-center rounded-md border border-transparent bg-blue-700 py-2 px-4 text-sm font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
            Valider
        </button>
    </form>    
</figure>
