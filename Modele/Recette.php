<?php
    ...
    final class Recette{
        ...
        private $_E_cout;
        private $_E_type_de_cuisson;
        private $_F_note_moyenne;
        private $_S_nom;


        function __construct($_A_list_ingredients, $_A_list_ustensiles, $_A_particularite, $_A_appreciations, $_B_photographie, $_D_temps_de_preparation, $_E_difficulte, $_E_cout, $_E_type_de_cuisson, $_F_note_moyenne, $_S_nom){
            ...
            $this->_E_type_de_cuisson = $_E_type_de_cuisson;
